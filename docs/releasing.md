...
6.  On a CentOS VM (where `rpm-build` is available), build Linux release
    packages:
        ...
        mkdir -p ~/tmp/release
        go get -v -u github.com/trungtran0689/gcsfuse/tools/package_gcsfuse
...
[tags]: https://github.com/Trungtran0689/gcsfuse/tags
[new-release]: https://github.com/Trungtran0689/gcsfuse/releases/new
